...
func show_sequence(
	...
	_bottom_bar.position.y = HIDDEN_OFFSET

	_tween = create_tween().set_trans(Tween.TRANS_CUBIC).set_ease(Tween.EASE_OUT)
	_tween.tween_property(_bottom_bar, "position:y", 0.0, TWEEN_DURATION)
...
func hide_line() -> void:
	...
	_tween.tween_property(_bottom_bar, "position:y", HIDDEN_OFFSET, TWEEN_DURATION)
