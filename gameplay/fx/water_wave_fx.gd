...
const SEGMENT_PIXEL_SIZE := 0.038
const LAUNCH_PIXEL_SIZE := 0.045
...
static func spawn_segment(parent: Node, origin: Vector3, direction: Vector3) -> void:
	...
	sprite.modulate = Color(0.35, 0.72, 1.0, 0.88)
	parent.add_child(sprite)
	sprite.global_position = origin + Vector3(0.0, 0.65, 0.0)
