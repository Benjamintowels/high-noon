...
const SPIN_ATTACK_SCENE := (
	MESHY_BASE + "Meshy_AI_Emerald_Embrace_biped_Animation_Axe_Spin_Attack_frame_rate_60.fbx"
)
...
const CLIP_SPIN_ATTACK_REVERSE := &"spin_attack_reverse"
...
const COMBAT_IDLE_BLEND := &"MeleeCombatIdleBlend"
const COMBAT_IDLE_ANIM := &"MeleeCombatIdleAnim"
const BLOCK_HOLD_BLEND := &"MeleeBlockHoldBlend"
const BLOCK_WALK_LOCOMOTION_BLEND := &"MeleeBlockWalkLocomotionBlend"
const BLOCK_WALK_LOCOMOTION_SPACE := &"BlockWalkLocomotionBlend"
const ATTACK_ONE_SHOT := &"MeleeAttackOneShot"
const ATTACK_TIME_SCALE := &"MeleeAttackTimeScale"
...
const ATTACK_TIME_SEEK := &"MeleeAttackTimeSeek"
